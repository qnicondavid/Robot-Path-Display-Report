...
## Movement Logic
The movement and position of the robot is calculated within the `stepRobot()` method. /n
It calculates 3 variables based on the four wheel inputs `FL`, `FR`, `BL`, and `BR`.
